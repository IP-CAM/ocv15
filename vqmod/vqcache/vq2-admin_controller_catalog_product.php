		...
		if (isset($this->request->post['model'])) {
			...
			$this->data['model'] = '';
				...
				if (isset($this->request->post['group_model'])) {
		      		$this->data['group_model'] = $this->request->post['group_model'];
		    	} elseif (!empty($product_info) && isset($product_info['group_model'])) {
					$this->data['group_model'] = $product_info['group_model'];
				} else {
		      		$this->data['group_model'] = '';
		    	}

		    	if (isset($this->request->post['model_tag'])) {
		      		$this->data['model_tag'] = $this->request->post['model_tag'];
		    	} elseif (!empty($product_info) && isset($product_info['model_tag'])) {
					$this->data['model_tag'] = $product_info['model_tag'];
				} else {
		      		$this->data['model_tag'] = '';
		    	}

		    	if (isset($this->request->post['chk_price'])) {
		      		$this->data['chk_price'] = $this->request->post['chk_price'];
		    	} elseif (!empty($product_info) && isset($product_info['chk_price'])) {
					$this->data['chk_price'] = $product_info['chk_price'];
				} else {
		      		$this->data['chk_price'] = '';
		    	}

		    	if (isset($this->request->post['chk_image'])) {
		      		$this->data['chk_image'] = $this->request->post['chk_image'];
		    	} elseif (!empty($product_info) && isset($product_info['chk_image'])) {
					$this->data['chk_image'] = $product_info['chk_image'];
				} else {
		      		$this->data['chk_image'] = '';
		    	}

		    	if (isset($this->request->post['chk_name'])) {
		      		$this->data['chk_name'] = $this->request->post['chk_name'];
		    	} elseif (!empty($product_info) && isset($product_info['chk_name'])) {
					$this->data['chk_name'] = $product_info['chk_name'];
				} else {
		      		$this->data['chk_name'] = '';
		    	}
