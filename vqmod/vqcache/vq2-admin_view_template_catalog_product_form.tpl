        ...
        <div id="tab-data">
          <table class="form">
            ...
            <tr>
				  ...
				  <td>Amazon-Style Group ID:</td>
	              <td>
	                  <input type="text" name="group_model" value="<?php echo $group_model; ?>" />
	                  &emsp;&emsp;
	                  Name to Display:&emsp;
	                  <input type="text" name="model_tag" value="<?php echo $model_tag; ?>" />
	                  &emsp;&emsp;
